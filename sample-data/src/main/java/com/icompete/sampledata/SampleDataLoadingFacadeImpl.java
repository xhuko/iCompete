...
public class SampleDataLoadingFacadeImpl implements SampleDataLoadingFacade {
    ...
    public void loadData() {
        ...
        Event eventSnowboarding = createEvent("Jasna Snowboarding 2017", "Description", "Jasna, Slovakia",sportSnowboarding, 10, getDate(2017,0,15), getDate(2017,0,18), new HashSet<>(Arrays.asList(new String[]{
