...
<my:pagetemplate title="Edit sport">
    <jsp:attribute name="body">

        <form:form method="post" action="${pageContext.request.contextPath}/sport/update" modelAttribute="sport" cssClass="form-horizontal">
            ...
            <button class="btn btn-warning" type="submit">Edit sport</button>
        </form:form>
